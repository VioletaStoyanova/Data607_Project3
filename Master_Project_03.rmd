...
names(sample1) <- c("list_ID", "city", "job_title", "company_name", "link", "summary","summary_full")
...
names(df1) <- c("list_ID", "city", "job_title", "company_name", "link", "summary","summary_full")
